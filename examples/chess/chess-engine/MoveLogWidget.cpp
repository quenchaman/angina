...
MoveLogWidget::MoveLogWidget(Point pos, GraphicsFactory& factory, Font& f, uint32_t cap)
...
void MoveLogWidget::add(std::string text, int32_t textWidth, Color color) {
     ...
     */
    Text* textTexture = textFactory.createText(text, font, Point::ZERO, Dimensions {textWidth, font.getSize()}, color);
