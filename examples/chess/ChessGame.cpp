...
Widget* ChessGame::buildLandingPage() {
    ...
    RectTextButton *computerVsComputerBtn = getFactory().createButton(
            GameConfig::COMPUTER_VS_COMPUTER_POS,
            GameConfig::DEFAULT_BTN_DIM,
            GameConfig::DEFAULT_BTN_BACKGROUND_COLOR,
            GameConfig::DEFAULT_BTN_TEXT_COLOR,
            GameConfig::COMPUTER_VS_COMPUTER_TEXT,
            defaultFont,
            std::bind(&ChessGame::handleComputerVSComputerButton, this));
...
Widget* ChessGame::buildChessPage() {
    ...
    RectTextButton *btn = getFactory().createButton(
            GameConfig::QUIT_GAME_BTN_POS, GameConfig::QUIT_GAME_BTN_DIM,
            GameConfig::DEFAULT_BTN_BACKGROUND_COLOR,
